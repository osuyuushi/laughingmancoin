...
unlocked to sign the Laughingmancoin-Qt.app bundle.
...
allowing somebody to distribute a Laughingmancoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the laughingmancoin-qt.exe file inside the installer had not been tampered with.
